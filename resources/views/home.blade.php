                ...
                <form method="POST" action="/chirps">
                    ...
                    <div class="form-control w-full">
                        <textarea name="message" placeholder="What's on your mind?"
                            class="textarea textarea-bordered w-full resize-none @error('message') texterea-error @enderror"
                            rows="4" maxlength="255" required>{{ old('message') }}</textarea>
                        {{-- <input type="file" name="avatar" accept="image/*" class="avatar-upload" title="upload avatar"> --}}
